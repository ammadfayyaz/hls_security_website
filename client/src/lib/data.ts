...
export const productCategories = [
  {
    ...
    icon: "bell",
    products: [
      { name: "Control Panels", description: "Intelligent control panels managing all alarm sensors and zones with programmable logic.", image: "/manus-storage/product-control-panel_0dae52ff.png", features: ["Up to 96 zones", "Wireless & wired support", "Remote programming", "Event logging"], specs: { "Power": "12V DC", "Backup": "7Ah battery", "Zones": "Up to 96", "Connectivity": "WiFi, GSM, IP" } },
      { name: "Motion Detectors", description: "PIR and dual-tech motion sensors with pet immunity and anti-mask technology.", image: "/manus-storage/product-motion-detector_fe0fcfcb.png", features: ["Pet immunity up to 40kg", "Anti-mask detection", "Dual technology", "12m range"], specs: { "Range": "12 meters", "Detection": "PIR + Microwave", "Pet Immunity": "Up to 40kg", "Power": "3V lithium" } },
      { name: "Door Sensors", description: "Magnetic contact sensors for doors and windows with tamper protection.", image: "/manus-storage/product-door-sensor_4f1e4276.png", features: ["Reed switch technology", "Tamper protection", "Wired or wireless", "Surface or flush mount"], specs: { "Gap": "Up to 50mm", "Type": "Reed switch", "Tamper": "Yes", "Power": "3V or wired" } },
      { name: "Glass Break Sensors", description: "Acoustic glass break detectors recognizing breaking glass patterns across frequencies.", image: "/manus-storage/product-glass-break-sensor_a327eaac.png", features: ["6m detection range", "Audio analysis", "Multi-pane detection", "False alarm filtering"], specs: { "Range": "6 meters", "Detection": "Acoustic", "Frequencies": "Low + High", "Power": "3V lithium" } },
      { name: "Outdoor Sensors", description: "Weather-resistant perimeter sensors for outdoor intrusion detection.", image: "/manus-storage/product-outdoor-sensor_0fd13f57.png", features: ["IP65 rated", "Anti-mask", "Pet immunity", "40m range"], specs: { "Range": "Up to 40m", "Rating": "IP65", "Detection": "Dual-tech", "Power": "9V or wired" } },
      { name: "Keypads", description: "Backlit keypads for system control with proximity tag and app integration.", image: "/manus-storage/product-keypad_29fa51ad.png", features: ["Backlit display", "Proximity tags", "App control", "Panic keys"], specs: { "Display": "Backlit LCD", "Tags": "Proximity", "Keys": "Panic + Fire", "Power": "12V DC" } },
      { name: "Sirens", description: "High-output indoor and outdoor sirens with strobe lights for visual deterrence.", image: "/manus-storage/product-siren_2a1ad663.png", features: ["118dB output", "Strobe light", "Tamper protected", "Weather resistant"], specs: { "Output": "118dB", "Strobe": "Yes", "Tamper": "Yes", "Rating": "IP54" } },
      { name: "Panic Buttons", description: "Wireless panic buttons for instant emergency alerts and response dispatch.", image: "/manus-storage/product-panic-button_a371132c.png", features: ["Wireless", "Wearable options", "Long battery life", "Silent alarm mode"], specs: { "Type": "Wireless", "Battery": "3 years", "Range": "100m", "Mounting": "Wall or wearable" } },
      { name: "Wireless Devices", description: "Complete range of wireless alarm components for flexible, cable-free installation.", image: "/manus-storage/product-wireless-device_1fcd3988.png", features: ["Two-way communication", "Encryption", "10-year battery", "Signal supervision"], specs: { "Frequency": "868MHz", "Encryption": "AES-128", "Battery": "Up to 10 years", "Supervision": "Continuous" } },
    ],
  },
  {
    name: "CCTV Systems",
    icon: "camera",
    products: [
      { name: "IP Cameras", description: "High-definition IP cameras with advanced analytics and remote viewing capabilities.", image: "/manus-storage/product-ip-camera_a9ff88c6.png", features: ["Up to 8MP resolution", "Wide dynamic range", "Night vision", "Remote access"], specs: { "Resolution": "Up to 8MP", "Lens": "2.8–12mm", "Night Vision": "Up to 50m", "Compression": "H.265+" } },
      { name: "PTZ Cameras", description: "Pan-tilt-zoom cameras with 360° coverage and auto-tracking functionality.", image: "/manus-storage/product-ptz-camera_3d15e3b3.png", features: ["360° pan", "25x optical zoom", "Auto-tracking", "Preset positions"], specs: { "Pan": "360°", "Tilt": "90°", "Zoom": "25x optical", "Presets": "Up to 300" } },
      { name: "NVR", description: "Network video recorders with large storage capacity and intelligent search.", image: "/manus-storage/product-nvr_bc9902c1.png", features: ["Up to 64 channels", "RAID storage", "Smart search", "Cloud backup"], specs: { "Channels": "Up to 64", "Storage": "Up to 80TB", "RAID": "0, 1, 5, 6", "Compression": "H.265+" } },
      { name: "AI Cameras", description: "AI-powered cameras with facial recognition, object detection, and behavior analysis.", image: "/manus-storage/product-ai-camera_9546acdf.png", features: ["Facial recognition", "Object detection", "Line crossing", "Intrusion detection"], specs: { "AI": "Deep learning", "Faces": "Up to 100,000", "Accuracy": "99.5%", "Processing": "Edge AI" } },
      { name: "Thermal Cameras", description: "Thermal imaging cameras for perimeter protection in all lighting conditions.", image: "/manus-storage/product-thermal-camera_1677d4af.png", features: ["See in total darkness", "Temperature measurement", "Fire detection", "Long range"], specs: { "Resolution": "384×288", "Range": "Up to 300m", "Sensitivity": "<40mK", "Detection": "Human, vehicle, fire" } },
      { name: "Video Analytics", description: "Advanced video analytics software for intelligent event detection and search.", image: "/manus-storage/product-video-analytics_5581bbdb.png", features: ["Motion detection", "Object left", "Crowd detection", "License plate recognition"], specs: { "Analytics": "20+ rules", "LPR": "Yes", "Integration": "ONVIF", "Platform": "Cloud or on-premise" } },
    ],
  },
  {
    name: "Electric Fence",
    icon: "zap",
    products: [
      { name: "Energizers", description: "High-voltage energizers delivering safe but effective deterrent pulses to perimeter fences.", image: "/manus-storage/product-energizer_8348abe5.png", features: ["10,000V pulse", "Zone monitoring", "Low power mode", "Battery backup"], specs: { "Voltage": "Up to 10,000V", "Zones": "Up to 10", "Backup": "12V battery", "Compliance": "IEC 60335" } },
      { name: "Fence Monitoring", description: "Real-time fence monitoring systems detecting intrusion attempts and tampering.", image: "/manus-storage/product-fence-monitor_e30aa0a1.png", features: ["Cut detection", "Climb detection", "Tamper alarm", "Zone mapping"], specs: { "Detection": "Cut, climb, tamper", "Zones": "Up to 10", "Response": "<1 second", "Interface": "TCP/IP" } },
      { name: "Warning Systems", description: "Audio and visual warning systems that activate upon fence approach or breach.", image: "/manus-storage/product-warning-system_52e4c14b.png", features: ["Voice warnings", "Strobe lights", "Pre-recorded messages", " programmable zones"], specs: { "Audio": "Up to 110dB", "Messages": "Pre-recorded", "Lights": "LED strobe", "Trigger": "Approach or breach" } },
      { name: "Accessories", description: "Complete range of electric fence accessories including insulators, posts, and wiring.", image: "/manus-storage/product-fence-accessories_a7a5b2c0.png", features: ["Insulators", "Fence posts", "Grounding kits", "Warning signs"], specs: { "Material": "UV-stabilized", "Warranty": "5 years", "Compliance": "IEC standards", "Installation": "Professional" } },
    ],
  },
  {
    name: "Fire Detection",
    icon: "flame",
    products: [
      { name: "Smoke Detectors", description: "Photoelectric and ionization smoke detectors with early warning capabilities.", image: "/manus-storage/product-smoke-detector_1fb36b49.png", features: ["Photoelectric sensing", "Heat backup", "Low battery alert", "Interconnectable"], specs: { "Type": "Photoelectric", "Sensitivity": "EN54-7", "Power": "9V or 12V", "Temperature": "-10°C to +55°C" } },
