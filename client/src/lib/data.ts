...
export const productCategories = [
  {
    ...
    icon: "bell",
    products: [
      { name: "Control Panels", description: "Intelligent control panels managing all alarm sensors and zones with programmable logic.", features: ["Up to 96 zones", "Wireless & wired support", "Remote programming", "Event logging"], specs: { "Power": "12V DC", "Backup": "7Ah battery", "Zones": "Up to 96", "Connectivity": "WiFi, GSM, IP" } },
      { name: "Motion Detectors", description: "PIR and dual-tech motion sensors with pet immunity and anti-mask technology.", features: ["Pet immunity up to 40kg", "Anti-mask detection", "Dual technology", "12m range"], specs: { "Range": "12 meters", "Detection": "PIR + Microwave", "Pet Immunity": "Up to 40kg", "Power": "3V lithium" } },
      { name: "Door Sensors", description: "Magnetic contact sensors for doors and windows with tamper protection.", features: ["Reed switch technology", "Tamper protection", "Wired or wireless", "Surface or flush mount"], specs: { "Gap": "Up to 50mm", "Type": "Reed switch", "Tamper": "Yes", "Power": "3V or wired" } },
      { name: "Glass Break Sensors", description: "Acoustic glass break detectors recognizing breaking glass patterns across frequencies.", features: ["6m detection range", "Audio analysis", "Multi-pane detection", "False alarm filtering"], specs: { "Range": "6 meters", "Detection": "Acoustic", "Frequencies": "Low + High", "Power": "3V lithium" } },
      { name: "Outdoor Sensors", description: "Weather-resistant perimeter sensors for outdoor intrusion detection.", features: ["IP65 rated", "Anti-mask", "Pet immunity", "40m range"], specs: { "Range": "Up to 40m", "Rating": "IP65", "Detection": "Dual-tech", "Power": "9V or wired" } },
      { name: "Keypads", description: "Backlit keypads for system control with proximity tag and app integration.", features: ["Backlit display", "Proximity tags", "App control", "Panic keys"], specs: { "Display": "Backlit LCD", "Tags": "Proximity", "Keys": "Panic + Fire", "Power": "12V DC" } },
      { name: "Sirens", description: "High-output indoor and outdoor sirens with strobe lights for visual deterrence.", features: ["118dB output", "Strobe light", "Tamper protected", "Weather resistant"], specs: { "Output": "118dB", "Strobe": "Yes", "Tamper": "Yes", "Rating": "IP54" } },
      { name: "Panic Buttons", description: "Wireless panic buttons for instant emergency alerts and response dispatch.", features: ["Wireless", "Wearable options", "Long battery life", "Silent alarm mode"], specs: { "Type": "Wireless", "Battery": "3 years", "Range": "100m", "Mounting": "Wall or wearable" } },
      { name: "Wireless Devices", description: "Complete range of wireless alarm components for flexible, cable-free installation.", features: ["Two-way communication", "Encryption", "10-year battery", "Signal supervision"], specs: { "Frequency": "868MHz", "Encryption": "AES-128", "Battery": "Up to 10 years", "Supervision": "Continuous" } },
    ],
  },
  {
    name: "CCTV Systems",
    icon: "camera",
    products: [
      { name: "IP Cameras", description: "High-definition IP cameras with advanced analytics and remote viewing capabilities.", features: ["Up to 8MP resolution", "Wide dynamic range", "Night vision", "Remote access"], specs: { "Resolution": "Up to 8MP", "Lens": "2.8–12mm", "Night Vision": "Up to 50m", "Compression": "H.265+" } },
      { name: "PTZ Cameras", description: "Pan-tilt-zoom cameras with 360° coverage and auto-tracking functionality.", features: ["360° pan", "25x optical zoom", "Auto-tracking", "Preset positions"], specs: { "Pan": "360°", "Tilt": "90°", "Zoom": "25x optical", "Presets": "Up to 300" } },
      { name: "NVR", description: "Network video recorders with large storage capacity and intelligent search.", features: ["Up to 64 channels", "RAID storage", "Smart search", "Cloud backup"], specs: { "Channels": "Up to 64", "Storage": "Up to 80TB", "RAID": "0, 1, 5, 6", "Compression": "H.265+" } },
      { name: "AI Cameras", description: "AI-powered cameras with facial recognition, object detection, and behavior analysis.", features: ["Facial recognition", "Object detection", "Line crossing", "Intrusion detection"], specs: { "AI": "Deep learning", "Faces": "Up to 100,000", "Accuracy": "99.5%", "Processing": "Edge AI" } },
      { name: "Thermal Cameras", description: "Thermal imaging cameras for perimeter protection in all lighting conditions.", features: ["See in total darkness", "Temperature measurement", "Fire detection", "Long range"], specs: { "Resolution": "384×288", "Range": "Up to 300m", "Sensitivity": "<40mK", "Detection": "Human, vehicle, fire" } },
      { name: "Video Analytics", description: "Advanced video analytics software for intelligent event detection and search.", features: ["Motion detection", "Object left", "Crowd detection", "License plate recognition"], specs: { "Analytics": "20+ rules", "LPR": "Yes", "Integration": "ONVIF", "Platform": "Cloud or on-premise" } },
    ],
  },
  {
    name: "Electric Fence",
    icon: "zap",
    products: [
      { name: "Energizers", description: "High-voltage energizers delivering safe but effective deterrent pulses to perimeter fences.", features: ["10,000V pulse", "Zone monitoring", "Low power mode", "Battery backup"], specs: { "Voltage": "Up to 10,000V", "Zones": "Up to 10", "Backup": "12V battery", "Compliance": "IEC 60335" } },
      { name: "Fence Monitoring", description: "Real-time fence monitoring systems detecting intrusion attempts and tampering.", features: ["Cut detection", "Climb detection", "Tamper alarm", "Zone mapping"], specs: { "Detection": "Cut, climb, tamper", "Zones": "Up to 10", "Response": "<1 second", "Interface": "TCP/IP" } },
      { name: "Warning Systems", description: "Audio and visual warning systems that activate upon fence approach or breach.", features: ["Voice warnings", "Strobe lights", "Pre-recorded messages", " programmable zones"], specs: { "Audio": "Up to 110dB", "Messages": "Pre-recorded", "Lights": "LED strobe", "Trigger": "Approach or breach" } },
      { name: "Accessories", description: "Complete range of electric fence accessories including insulators, posts, and wiring.", features: ["Insulators", "Fence posts", "Grounding kits", "Warning signs"], specs: { "Material": "UV-stabilized", "Warranty": "5 years", "Compliance": "IEC standards", "Installation": "Professional" } },
    ],
  },
  {
    name: "Fire Detection",
    icon: "flame",
    products: [
      { name: "Smoke Detectors", description: "Photoelectric and ionization smoke detectors with early warning capabilities.", features: ["Photoelectric sensing", "Heat backup", "Low battery alert", "Interconnectable"], specs: { "Type": "Photoelectric", "Sensitivity": "EN54-7", "Power": "9V or 12V", "Temperature": "-10°C to +55°C" } },
      { name: "Heat Detectors", description: "Fixed temperature and rate-of-rise heat detectors for harsh environments.", features: ["Fixed 57°C", "Rate-of-rise", "Spark-free", "Dust resistant"], specs: { "Type": "Fixed + ROR", "Threshold": "57°C", "Rate": "8°C/min", "Rating": "IP54" } },
      { name: "Manual Call Points", description: "Emergency manual call points for fire alarm activation with reset mechanism.", features: ["Break-glass design", "Resettable", "LED indicator", "Weatherproof options"], specs: { "Type": "Break-glass", "Reset": "Key or test", "Indicator": "LED", "Rating": "IP54 optional" } },
      { name: "Control Panels", description: "Intelligent fire alarm control panels with addressable detection and zoning.", features: ["Addressable loops", "Cause & effect", "Event log", "Integration ready"], specs: { "Loops": "Up to 8", "Devices": "Up to 240/loop", "Zones": "Up to 200", "Interface": "TCP/IP, RS485" } },
      { name: "Notification Devices", description: "Sounders, strobes, and beacons for audible and visual fire alarm notification.", features: ["Up to 115dB", "LED strobe", "Multi-tone", "Weatherproof"], specs: { "Output": "Up to 115dB", "Tones": "32 selectable", "Strobe": "LED", "Rating": "IP54" } },
    ],
  },
  {
    ...
    icon: "gate",
    products: [
      { name: "Sliding Gates", description: "Automated sliding gate systems for residential and commercial entrances.", features: ["Up to 1200kg", "Soft start/stop", "Obstacle detection", "Remote control"], specs: { "Capacity": "Up to 1200kg", "Speed": "12m/min", "Motor": "24V DC", "Safety": "Photocell + edge" } },
      { name: "Swing Gates", description: "Electromechanical swing gate operators for double-leaf gate entrances.", features: ["Up to 500kg/leaf", "Adjustable speed", "Anti-crush", "Battery backup"], specs: { "Capacity": "Up to 500kg/leaf", "Opening": "90° in 15s", "Motor": "24V DC", "Backup": "Yes" } },
      { name: "Barrier Systems", description: "Boom barrier systems for parking lots and vehicle access control.", features: ["Up to 6m boom", "Fast operation", "Safety photocells", "Ticket dispenser"], specs: { "Boom": "Up to 6m", "Speed": "1.5–6 seconds", "Motor": "24V DC", "Safety": "Photocell + loop" } },
      { name: "Access Control", description: "Card, biometric, and mobile-based access control systems for gates and doors.", features: ["RFID cards", "Fingerprint", "Mobile credentials", "Visitor management"], specs: { "Methods": "Card, biometric, mobile", "Users": "Up to 30,000", "Connectivity": "TCP/IP", "Integration": "ONVIF, Wiegand" } },
    ],
  },
  {
    ...
    icon: "home",
    products: [
      { name: "Lighting Control", description: "Smart lighting systems with scene control, scheduling, and remote operation.", features: ["Scene control", "Dimming", "Color tuning", "Scheduling"], specs: { "Control": "App, voice, switch", "Protocols": "Zigbee, Z-Wave", "Dimming": "0–100%", "Scenes": "Unlimited" } },
      { name: "Curtain Control", description: "Automated curtain and blind control integrated with smart home scenes.", features: ["Motorized tracks", "Schedule control", "Scene integration", "Sunrise/sunset"], specs: { "Control": "App, voice", "Motor": "Quiet DC", "Tracks": "Custom sizes", "Integration": "Zigbee" } },
      { name: "Smart Locks", description: "Keyless smart door locks with multiple access methods and audit trails.", features: ["Fingerprint", "PIN code", "RFID card", "Remote unlock"], specs: { "Methods": "Fingerprint, PIN, card, app", "Battery": "Up to 12 months", "Audit": "Full log", "Backup": "Mechanical key" } },
      { name: "Climate Control", description: "Smart thermostat and HVAC control for energy-efficient temperature management.", features: ["Smart scheduling", "Geo-fencing", "Energy reports", "Multi-zone"], specs: { "Control": "App, voice", "Zones": "Up to 16", "Savings": "Up to 30%", "Protocols": "Zigbee, WiFi" } },
      { name: "Energy Monitoring", description: "Real-time energy monitoring and reporting for optimized consumption.", features: ["Real-time data", "Historical reports", "Cost tracking", "Alerts"], specs: { "Monitoring": "Per circuit", "Accuracy": "±1%", "Reports": "Daily, weekly, monthly", "Alerts": "Threshold-based" } },
      { name: "Scenes", description: "Pre-configured automation scenes combining lighting, climate, security, and more.", features: ["One-tap scenes", "Custom scenes", "Schedule-based", "Event-triggered"], specs: { "Scenes": "Unlimited", "Triggers": "Time, location, event", "Devices": "All compatible", "Control": "App, voice" } },
      { name: "Voice Control", description: "Integration with Amazon Alexa, Google Assistant, and Apple HomeKit for hands-free control.", features: ["Alexa compatible", "Google Assistant", "Apple HomeKit", "Custom commands"], specs: { "Platforms": "Alexa, Google, HomeKit", "Commands": "Custom", "Languages": "Multi-language", "Privacy": "Local processing" } },
    ],
  },
];
